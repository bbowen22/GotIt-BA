...
public class CancellationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stk = findViewById(R.id.tablemain5);

        loadCancellations();

        Spinner spinner = findViewById(R.id.cancellations_spinner);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                btnFilter = findViewById(R.id.filter5);
                    ...
                    btnFilter.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (list0.contains(s)) {
                                ...
                                Toast.makeText(CancellationsActivity.this, "Sorry, search invalid!", Toast.LENGTH_LONG).show();
                            }
                        }
